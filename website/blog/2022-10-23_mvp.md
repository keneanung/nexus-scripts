...
The success of this project is strongly linked with how extensive the [list of available packages](https://keneanung.github.io/nexus-package-repository/) is. So, if you know of a package or have authored one yourself, please head over to the [package repository](https://github.com/keneanung/nexus-package-repository) and either add the package via pull request or open an issue so I can add it.
